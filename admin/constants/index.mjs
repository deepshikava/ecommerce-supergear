...
export const categories = [
  {
    ...
    description:
      "Explore high-quality televisions and immersive audio systems for the ultimate home entertainment experience.",
    _base: "tvAndAudio",
  },
  {
    _id: 1002,
    ...
    description:
      "Stream your favorite content with smart TV boxes offering apps, live TV, and on-demand entertainment.",
    _base: "tvBox",
  },
  {
    _id: 1003,
    ...
    description:
      "Get the job done efficiently with durable and high-performance power tools for home and professional use.",
    _base: "powerTools",
  },
  {
    _id: 1004,
    ...
    description:
      "Enjoy crystal-clear sound with stylish and comfortable headphones for music, calls, and gaming.",
    _base: "headphones",
  },
  {
    _id: 1005,
    ...
    description:
      "Discover the latest smartphones with advanced features, powerful performance, and sleek designs.",
    _base: "cellPhones",
  },
  {
    _id: 1006,
    ...
    description:
      "Stay connected and track your health with smartwatches featuring fitness monitoring and smart notifications.",
    _base: "smartWatches",
  },
  {
    _id: 1007,
    ...
    description:
      "Dive into immersive gaming and video experiences with the latest consoles, accessories, and titles.",
    _base: "gameAndVideo",
  },
  {
    _id: 1008,
    ...
    description:
      "Automate your home cleaning with smart robot vacuums designed for efficient and hands-free operation.",
    _base: "robotClean",
  },
  {
    _id: 1009,
    ...
    description:
      "Track your workouts and outdoor activities with rugged sport watches built for performance and durability.",
    _base: "sportWatches",
  },
  {
    _id: 1010,
    ...
    description:
      "Browse, work, and play on versatile tablets offering portability, performance, and vibrant displays.",
    _base: "tablets",
  },
  {
    _id: 1011,
    ...
    description:
      "Find powerful desktops and laptops suited for work, gaming, and everyday productivity needs.",
  ...
  },
  {
    ...
    description:
      "Capture stunning photos and videos with advanced cameras and photography accessories.",
...
export const blogsData = [
  {
    ...
    _base: "Technology",
    description:
      "Apple’s iPhone 15 is expected to introduce a refined rear camera design with improved lens alignment and enhanced sensor capabilities, delivering better low-light performance, sharper images, and advanced computational photography features for everyday users.",
  },
  {
    _id: 4002,
    ...
    _base: "Samrt thing",
    description:
      "Learn how to properly set up your surround sound speaker system, including speaker placement, calibration, and connectivity, to achieve immersive audio quality and a true cinematic experience in your home.",
  },
  {
    _id: 4003,
    ...
    _base: "Life style",
    description:
      "A step-by-step guide to connecting and configuring an AV receiver for your home theater, covering input/output setup, speaker wiring, and optimizing audio and video performance for seamless entertainment.",
  },
];
...
export const products = [
  {
    ...
    description:
      "A unique retro-style Bluetooth speaker featuring customizable pixel art display, built-in alarm clock, and app-controlled LED lighting—perfect as a decorative smart gadget and gift.",
    regularPrice: 600,
    discountedPrice: 580,
    quantity: 1,
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "A lightweight smartwatch with built-in GPS, heart rate monitoring, and multiple fitness modes, designed to track workouts and daily activity with a vibrant 1.4-inch display.",
    regularPrice: 250,
    discountedPrice: 180,
    quantity: 1,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "An affordable fitness tracker with heart rate monitoring, step tracking, and activity logging, suitable for everyday health tracking across iOS and Android devices.",
    regularPrice: 650,
    discountedPrice: 570,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "A compact 4K action camera with WiFi connectivity, remote control support, and waterproof design—ideal for capturing outdoor adventures and sports footage.",
    regularPrice: 400,
    discountedPrice: 350,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "A smart Bluetooth speaker with voice control, music streaming, and compact design, offering seamless connectivity for everyday home entertainment.",
    regularPrice: 90,
    discountedPrice: 80,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Feature-packed smartwatch with fitness tracking, GPS, and long battery life, designed for active users seeking performance and convenience.",
    regularPrice: 300,
    discountedPrice: 280,
    quantity: 1,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "Foldable wireless headphones with built-in microphone, delivering clear audio and comfortable wear for music, calls, and travel use.",
    regularPrice: 600,
    discountedPrice: 550,
    quantity: 1,
    rating: 4,
  ...
  },
  {
    ...
    description:
      "A slim and portable laptop designed for business, office work, and light gaming, offering reliable performance with a sleek and modern design.",
    regularPrice: 1100,
  ...
  },
  {
    ...
    description:
      "Smart robot vacuum with powerful suction, LDS navigation, and dual sweeping and mopping functions for efficient automated home cleaning.",
    regularPrice: 450,
    discountedPrice: 380,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "A powerful smartphone featuring 6GB RAM, large display, and long-lasting battery, delivering smooth performance for daily multitasking and entertainment.",
    regularPrice: 305,
    discountedPrice: 285,
    quantity: 1,
    rating: 4.1,
  ...
  },
  {
    ...
    description:
      "A wireless security camera with pan-tilt functionality, full HD video, and remote monitoring, providing reliable home surveillance and safety.",
    regularPrice: 350,
    discountedPrice: 280,
    quantity: 1,
    rating: 3.8,
  ...
  },
  {
    ...
    description:
      "Compact cordless glue gun ideal for DIY crafts and repairs, offering quick heating and easy handling for home and professional projects.",
    regularPrice: 150,
    discountedPrice: 80,
    quantity: 1,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Android TV box supporting 4K streaming, apps, and voice control, transforming your TV into a smart entertainment hub.",
    regularPrice: 210,
    discountedPrice: 200,
    quantity: 1,
    rating: 3.9,
  ...
  },
  {
    ...
    description:
      "Wireless PS4 controller with responsive buttons, vibration feedback, and ergonomic design for an enhanced gaming experience.",
    regularPrice: 80,
    discountedPrice: 75,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Reliable cordless drill with 12V lithium battery, suitable for drilling and screw-driving tasks in home improvement projects.",
    regularPrice: 560,
    discountedPrice: 400,
    quantity: 1,
    rating: 4,
  ...
  },
  {
    ...
    description:
      "Durable outdoor Bluetooth speaker with IP55 water and dust resistance, delivering powerful sound for travel and outdoor use.",
    regularPrice: 250,
    discountedPrice: 240,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Compact TV stick with Android TV support, enabling streaming apps and smart features directly on your television.",
    regularPrice: 60,
    discountedPrice: 55,
    quantity: 1,
    rating: 4,
  ...
  },
  {
    ...
    description:
      "Digital writing tablet with pressure-sensitive pen, perfect for note-taking, sketching, and eco-friendly paperless communication.",
    regularPrice: 350,
    discountedPrice: 330,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Stylish fabric-finished Bluetooth speaker designed for both indoor and outdoor use, combining aesthetics with quality sound.",
    regularPrice: 120,
    discountedPrice: 100,
    quantity: 1,
    rating: 4.1,
  ...
  },
  {
    ...
    description:
      "Versatile smartphone with strong performance, large storage, and dual SIM capability, ideal for daily communication and entertainment.",
    regularPrice: 450,
    discountedPrice: 410,
    quantity: 1,
    rating: 3.7,
  ...
  },
  {
    ...
    description:
      "True wireless earbuds with Bluetooth 5.0, delivering deep bass, stable connectivity, and comfortable fit for everyday listening.",
    regularPrice: 350,
    discountedPrice: 320,
    quantity: 1,
    rating: 3.9,
  ...
  },
  {
    ...
    description:
      "Advanced robot vacuum with sonic mopping, intelligent navigation, and strong suction power for deep and efficient cleaning.",
    regularPrice: 250,
    discountedPrice: 240,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "High-performance subwoofer delivering deep bass and detailed sound, perfect for enhancing home theater audio systems.",
    regularPrice: 600,
    discountedPrice: 580,
    quantity: 1,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Compact MP3/MP4 player with lightweight design, ideal for music on the go during workouts and outdoor activities.",
    regularPrice: 80,
    discountedPrice: 70,
    quantity: 1,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Smartwatch with fitness tracking, GPS, and water resistance, offering reliable performance for health monitoring and daily use.",
    regularPrice: 220,
    discountedPrice: 210,
    quantity: 1,
    rating: 4.5,
